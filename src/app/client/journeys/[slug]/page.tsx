...
export default async function ClientJourneyPage({ params }: JourneyPageProps) {
  ...
  return (
    <div className="h-full overflow-y-auto px-4 py-10">
      <div className="border-white/12 bg-white/92 mx-auto w-full max-w-[1200px] space-y-16 rounded-[40px] border px-10 py-16 text-foreground shadow-[0_45px_140px_-80px_rgba(10,10,20,0.65)]">
