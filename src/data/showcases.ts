...
const allJourneyShowcases: JourneyShowcase[] = [
  ...
  },
  {
    ...
    title: 'Portugal',
    headline:
      'Three Atlantic perspectives, from volcanic silence to cloud mountains and Lisbon light.',
    locale: 'Azores, Madeira & Lisboa, Portugal',
    timeframe: 'From 1st June to 30th September',
    summary:
      'A three-location Portugal journey shaped by the volcanic calm of the Azores, Madeira’s elevated wilderness, and Lisboa’s tiled urban light.',
    story: [
      ...
      'Madeira lifts the story above the clouds, between laurel forests, sculpted peaks, and cliffs falling sharply into Atlantic blue.',
      'Lisboa closes the journey in warm city light, where tiled facades, steep streets, and the Tagus give the narrative a vivid, human rhythm.',
    ],
    highlights: [
      'Volcanic-lake storytelling between crater ridges, hydrangeas, mist, and luminous Atlantic skies',
      'Madeira chapters shaped by cloud-level paths, botanical abundance, and dramatic ocean cliffs',
      'Lisboa scenes built around azulejos, trams, terraces, and warm Atlantic city light',
    ],
    logistics: [
      'One coherent Portugal production arc planned across the Azores, Madeira, and Lisboa',
      'Flexible art direction moving from elemental nature to textured urban storytelling',
      'Editorial and motion delivery adapted for luxury, lifestyle, hospitality, and ecology-led narratives',
    ],
    hero: {
      id: 'azores-hero',
      type: 'image',
      src: '/assets/journeys/portugal-2026/portugal-azores.webp',
      alt: 'Portugal journey opening in the volcanic Azores',
      aspectRatio: 'landscape',
      caption: 'Portugal opening frame — Azores',
    ...
    gallery: [
      {
        ...
        type: 'image',
        src: '/assets/journeys/portugal-2026/portugal-azores.webp',
        alt: 'Azores volcanic lakes and Atlantic landscape',
        aspectRatio: 'landscape',
        caption: 'Azores',
      },
      {
        ...
        type: 'image',
        src: '/assets/journeys/portugal-2026/portugal-madeira.webp',
        alt: 'Madeira mountain and coastal landscape',
        aspectRatio: 'landscape',
        caption: 'Madeira',
      },
      {
        ...
        type: 'image',
        src: '/assets/journeys/portugal-2026/portugal-lisboa.webp',
        alt: 'Lisboa tiled streets and warm city light',
        aspectRatio: 'landscape',
        caption: 'Lisboa',
      },
    ],
    cta: {
      label: 'Discuss Portugal',
      href: 'mailto:hello@beeyondtheworld.com?subject=Portugal%20Journey',
    },
  },
  {
    id: 'thailand',
...
export const campaignShowcases: CampaignShowcase[] = [
  ...
  },
  {
    ...
    hero: {
      ...
      type: 'video',
      src: '/assets/campaigns/craie-suisse/craie-suisse-story.mp4',
      alt: 'Craie Studio seasonal tale in Switzerland',
      poster: '/assets/campaigns/craie-suisse/craie-suisse-cover.jpg',
      caption: 'Switzerland · seasonal tale',
      loopLabel: 'Campaign 04',
    },
    gallery: [
      {
        id: 'craie-suisse-spring-cover',
        type: 'image',
        src: '/assets/campaigns/craie-suisse/craie-suisse-cover.jpg',
        alt: 'Craie Studio spring chapter beside a Swiss mountain lake',
        aspectRatio: 'landscape',
      },
      {
        id: 'craie-suisse-spring-wide',
        type: 'image',
        src: '/assets/campaigns/craie-suisse/craie-suisse-spring-04.jpg',
        alt: 'Craie Studio spring portrait in the Swiss mountains',
        aspectRatio: 'landscape',
      },
      {
        id: 'craie-suisse-spring-low-angle',
        type: 'image',
        src: '/assets/campaigns/craie-suisse/craie-suisse-spring-02.jpg',
        alt: 'Craie Studio spring look beside a Swiss mountain lake',
        aspectRatio: 'landscape',
      },
      {
        id: 'craie-suisse-spring-back',
        type: 'image',
        src: '/assets/campaigns/craie-suisse/craie-suisse-spring-03.jpg',
        alt: 'Craie Studio spring bags in the Swiss landscape',
        aspectRatio: 'portrait',
      },
      {
        id: 'craie-suisse-spring-lake-portrait',
        type: 'image',
        src: '/assets/campaigns/craie-suisse/swiss3.jpg',
        alt: 'Craie Studio spring portrait by the Swiss mountain lake',
        aspectRatio: 'landscape',
      },
      {
        id: 'craie-suisse-winter-01',
        type: 'image',
        src: '/assets/campaigns/craie-suisse/craie-suisse-winter-01.jpg',
        alt: 'Craie Studio winter portrait beside a frozen Swiss lake',
        aspectRatio: 'landscape',
      },
      {
        id: 'craie-suisse-winter-02',
        type: 'image',
        src: '/assets/campaigns/craie-suisse/craie-suisse-winter-02.jpg',
        alt: 'Craie Studio silver bag in the Swiss snow',
        aspectRatio: 'portrait',
      },
      {
        id: 'craie-suisse-winter-04',
        type: 'image',
        src: '/assets/campaigns/craie-suisse/craie-suisse-winter-04.jpg',
        alt: 'Craie Studio green and gold bag with flowers in the Swiss snow',
        aspectRatio: 'landscape',
      },
      {
        id: 'craie-suisse-winter-03',
        type: 'image',
        src: '/assets/campaigns/craie-suisse/craie-suisse-winter-03.jpg',
        alt: 'Craie Studio winter look in Switzerland',
        aspectRatio: 'landscape',
      },
    ],
    impact: [
  ...
  },
  {
    ...
    hero: {
      ...
      type: 'video',
      src: '/assets/campaigns/grace-mila-morocco/grace-mila-morocco-fw.mp4',
      poster: '/assets/campaigns/grace-mila-morocco/grace-mila-morocco-fw-cover.jpg',
      alt: 'Grace and Mila Fall Winter campaign in Morocco',
      caption: 'Morocco · Fall Winter 2024 / Spring Summer 2024',
      loopLabel: 'Campaign 05',
    },
    gallery: [
      {
        id: 'grace-mila-morocco-fw-01',
        type: 'image',
        src: '/assets/campaigns/grace-mila-morocco/grace-mila-morocco-fw-01.jpg',
        alt: 'Grace and Mila Fall Winter look in Morocco',
        aspectRatio: 'portrait',
      },
      {
        id: 'grace-mila-morocco-fw-02',
        type: 'image',
        src: '/assets/campaigns/grace-mila-morocco/grace-mila-morocco-fw-02.jpg',
        alt: 'Grace and Mila Fall Winter portrait in the Moroccan desert',
        aspectRatio: 'portrait',
      },
      {
        id: 'grace-mila-morocco-fw-03',
        type: 'image',
        src: '/assets/campaigns/grace-mila-morocco/grace-mila-morocco-fw-03.jpg',
        alt: 'Grace and Mila Fall Winter silhouette on a Moroccan dune',
        aspectRatio: 'portrait',
      },
      {
        id: 'grace-mila-morocco-ss-video',
        type: 'video',
        src: '/assets/campaigns/grace-mila-morocco/grace-mila-morocco-ss.mp4',
        poster: '/assets/campaigns/grace-mila-morocco/grace-mila-morocco-ss-cover.jpg',
        alt: 'Grace and Mila Spring Summer campaign in Morocco',
      },
      {
        id: 'grace-mila-morocco-ss-01',
        type: 'image',
        src: '/assets/campaigns/grace-mila-morocco/grace-mila-morocco-ss-01.jpg',
        alt: 'Grace and Mila Spring Summer yellow suit in Morocco',
        aspectRatio: 'portrait',
      },
      {
        id: 'grace-mila-morocco-ss-02',
        type: 'image',
        src: '/assets/campaigns/grace-mila-morocco/grace-mila-morocco-ss-02.jpg',
        alt: 'Grace and Mila Spring Summer coastal portrait in Morocco',
        aspectRatio: 'portrait',
      },
      {
        id: 'grace-mila-morocco-ss-03',
        type: 'image',
        src: '/assets/campaigns/grace-mila-morocco/grace-mila-morocco-ss-03.jpg',
        alt: 'Grace and Mila Spring Summer look in Morocco',
        aspectRatio: 'portrait',
      },
    ],
    impact: [
  ...
  },
  {
    ...
    hero: {
      ...
      poster: '/assets/campaigns/ange-new-york/ange-new-york-drive-01.jpg',
    ...
    gallery: [
      {
        ...
        aspectRatio: 'portrait',
        caption: 'Midtown portrait',
      },
      {
        id: 'ange-new-york-gallery-02',
        type: 'image',
        src: '/assets/campaigns/ange-new-york/ange-new-york-drive-02.jpg',
        alt: "AN'GE Fall Winter portrait against a New York brick wall",
        aspectRatio: 'portrait',
        caption: 'Brick wall portrait',
      },
      {
        id: 'ange-new-york-gallery-03',
        type: 'image',
        src: '/assets/campaigns/ange-new-york/ange-new-york-drive-03.jpg',
        alt: "AN'GE Fall Winter coat and dress in Midtown New York",
        aspectRatio: 'portrait',
        caption: 'Midtown movement',
      },
      {
        id: 'ange-new-york-gallery-04',
        type: 'image',
        src: '/assets/campaigns/ange-new-york/ange-new-york-drive-04.jpg',
        alt: "AN'GE Fall Winter portrait beside a yellow New York taxi",
        aspectRatio: 'portrait',
        caption: 'Taxi portrait',
      },
    ],
    impact: [
